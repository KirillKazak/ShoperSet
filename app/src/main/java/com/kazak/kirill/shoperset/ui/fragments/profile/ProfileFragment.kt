...
import com.kazak.kirill.shoperset.ui.customViews.CustomViewItemProfile
    ...
    private fun observeCurrentUserCredentialsLiveData() {
        vm.userNameAndPhotoLiveData.observe(viewLifecycleOwner) {currentUserCredentials ->
            with(vb) {
                ...
                vb.ivUserPhotoProfile.loadImageWithPlaceholder(
                    currentUserCredentials.userPhoto, R.drawable.icon_user_placeholder)
            }
        }
    }
